\subsection{Mars}
\initial{S}o far, we have seen how the human urge to explore has formed the fields of biology and astronomy, and the technological innovations this has led to.
...
\begin{center}
	\includegraphics[width=0.475\textwidth]{2020_Rover_Sketch.jpg}
	\tiny{Credit: NASA/JPL-Caltech}
\end{center}

\initial{T}he Mars 2020 rover mission is NASAs next contribution to the exploration of the red planet. 
...
\initial{T}he European Space Agency (ESA) considers the question \emph{"did life ever exist on Mars?"} as one of the most important scientific questions of our time.
...
\begin{center}
	\includegraphics[width=0.475\textwidth]{ExoMars.jpg}
	\tiny{Credit: ESA}
\end{center}
...
\initial{A} sample return mission would collect a sample of rock and dust on the surface of Mars to return to Earth.
...
\begin{center}
	\includegraphics[width=0.475\textwidth]{Sample_return_concept.jpg}
	\tiny{Credit: ESA}
\end{center}
...
\input{"Part3_Searching_in_the_future/FactboxTitan.tex"}

...
\begin{abstract}
Dokument om Roveren på Mars - Curiosity. Bruker blant annet \cite{NASA-rover} og internett som kilder for å skrive.
\end{abstract}

\end{frontmatter}

\section*{Laser og shit!}

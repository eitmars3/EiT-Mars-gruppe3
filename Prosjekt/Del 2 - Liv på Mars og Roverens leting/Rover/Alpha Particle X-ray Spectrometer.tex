...
Spektrometer bruker curium for kilde til alphapartikler og røntgenstråler.
En sensor chip i sensorhodet registrerer strålingen som kommer fra materialer som treffes av alphapartiklene og røntgenstrålene.
